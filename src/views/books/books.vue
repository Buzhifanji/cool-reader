  ...
  <template v-if="books.length">
    ...
    <div class="list-wrapper" v-for="item in books" :key="item.id">
      ...
      <div class="list-content-right">
        <div>
          <i class="icon">
            <svg t="1670912142614" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="5110" width="200" height="200">
              <path
        ...
        <div>
          <i class="icon">
            <svg t="1670912176743" class="icon" viewBox="0 0 1117 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="5321" width="200" height="200">
              <path
