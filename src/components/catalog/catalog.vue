<template>
  <n-menu v-if="readingBook.catalog.length" :collapsed-icon-size="22" :options="readingBook.catalog"
    :key-field="menuFieds.key" :label-field="menuFieds.label" :children-field="menuFieds.children"
