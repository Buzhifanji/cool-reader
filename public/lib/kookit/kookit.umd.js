!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : e(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).Kookit =
          {})
      );
})(this, function (t) {
  "use strict";
  ...
  const l = (t, e = !1) =>
      ...
      for (
        ...
        ((!(
          ...
          ((/^[\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07\u842c\u96f6]+$/.test(
            e.substring(1, e.indexOf(r[t])).trim()
          ) ||
            /^\d+$/.test(e.substring(1, e.indexOf(r[t])).trim())) &&
            (i = !0),
            !i));
        t++
      );
    ...
    n = (t) =>
      !(
        !/^[\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07\u842c\u96f6]+$/.test(
          t.substring(1, t.indexOf(" "))
        ) && !/^\d+$/.test(t.substring(1, t.indexOf(" ")))
      ) ||
      !(
        !/^[\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07\u842c\u96f6]+$/.test(
          t.substring(1, t.indexOf("　"))
    ...
    o = (t) =>
      ...
      !!/^\d+$/.test(t.substring(0, t.indexOf(" "))) ||
      !!/^\d+$/.test(t.substring(0, t.indexOf("　"))),
    s = (t) =>
      !!/^[\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07\u842c\u96f6]+$/.test(
        t.substring(0, t.indexOf(":"))
  ...
  function N(n, o) {
    return (
      (o = null == o ? n.length - 1 : +o),
      function () {
        for (
          var t = Math.max(arguments.length - o, 0), e = Array(t), i = 0;
          i < t;
          i++
        )
          e[i] = arguments[i + o];
  ...
  function dt(t, e) {
    ...
    var i = O.length,
      ...
      n = (V(r) && r.prototype) || v,
      o = "constructor";
    for (et(t, o) && !e.contains(o) && e.push(o); i--;)
      (o = O[i]) in t && t[o] !== n[o] && !e.contains(o) && e.push(o);
  }
  function gt(t) {
    if (!M(t)) return [];
    if (D) return D(t);
  ...
  function bt(t, e, i, r) {
    ...
    var n = typeof t;
    return (
      ("function" == n || "object" == n || "object" == typeof e) &&
      (function t(e, i, r, n) {
        ...
        if (!s) {
          ...
          if (
            o !== a &&
            !(V(o) && o instanceof o && V(a) && a instanceof a) &&
            "constructor" in e &&
            "constructor" in i
          )
            return !1;
        ...
        n = n || [];
        var l = r.length;
        for (; l--;) if (r[l] === e) return n[l] === i;
        r.push(e);
        n.push(i);
        if (s) {
          if ((l = e.length) !== i.length) return !1;
          for (; l--;) if (!bt(e[l], i[l], r, n)) return !1;
        } else {
          var h,
            c = gt(e);
          if (((l = c.length), gt(i).length !== l)) return !1;
          for (; l--;)
  ...
  function Lt(r) {
    ...
    return function (t) {
      ...
      var e = xt(t);
      if (ft(e)) return !1;
      for (var i = 0; i < n; i++) if (!V(t[r[i]])) return !1;
      return r !== Dt || !V(t[Tt]);
    };
  }
  var Tt = "forEach",
    ...
    It = U("WeakSet");
  function Ot(t) {
    for (var e = gt(t), i = e.length, r = Array(i), n = 0; n < i; n++)
      r[n] = t[e[n]];
    return r;
  }
  function At(t) {
    for (var e = {}, i = gt(t), r = 0, n = i.length; r < n; r++)
      e[t[i[r]]] = i[r];
    return e;
  }
  function Nt(t) {
  ...
  var de = N(function (n, o) {
    function s() {
      for (var t = 0, e = o.length, i = Array(e), r = 0; r < e; r++)
        i[r] = o[r] === a ? arguments[t++] : o[r];
  ...
  function pe(t, e, i, r) {
    ...
    for (var n = r.length, o = 0, s = ft(t); o < s; o++) {
      ...
      if (me(a) && (tt(a) || rt(a)))
        ...
        else for (var l = 0, h = a.length; l < h;) r[n++] = a[l++];
      else i || (r[n++] = a);
    }
    return r;
  }
  var ve = N(function (t, e) {
    var i = (e = pe(e, !1, !1)).length;
  ...
  function De(o, s, a) {
    return function (t, e, i) {
      ...
      if ("number" == typeof i)
        0 < o
          ? (r = 0 <= i ? i : Math.max(i + n, r))
          : (n = 0 <= i ? Math.min(i + 1, n) : i + n + 1);
  ...
  function Be(t, e, i) {
    e = Qt(e, i);
    for (
      var r = !me(t) && gt(t), n = (r || t).length, o = Array(n), s = 0;
      s < n;
      s++
    ) {
      var a = r ? r[s] : s;
  ...
  function Ae(t, e, i) {
    e = Qt(e, i);
    for (var r = !me(t) && gt(t), n = (r || t).length, o = 0; o < n; o++) {
      var s = r ? r[o] : o;
  ...
  function Me(t, e, i, r) {
    return (
      me(t) || (t = Ot(t)),
      0 <= _e(t, e, (i = "number" != typeof i || r ? 0 : i))
    );
  }
  X = N(function (t, i, r) {
    var n, o;
    return (
      V(i)
        ? (o = i)
        : ((i = zt(i)), (n = i.slice(0, -1)), (i = i[i.length - 1])),
      Be(t, function (t) {
        var e = o;
        if (!e) {
  ...
  function We(t, r, e) {
    ...
    if (
      ...
      for (var a = 0, l = (t = me(t) ? t : Ot(t)).length; a < l; a++)
        null != (i = t[a]) && o < i && (o = i);
    else
      (r = Qt(r, e)),
        Ee(t, function (t, e, i) {
          (n = r(t, e, i)),
            (s < n || (n === -1 / 0 && o === -1 / 0)) && ((o = t), (s = n));
        });
    return o;
  }
  function Ue(t, e, i) {
  ...
  var ze = N(function (t, e) {
    ...
    if (null == t) return i;
    V(r)
      ? (1 < e.length && (r = Vt(r, e[1])), (e = xt(t)))
      : ((r = Ke), (e = pe(e, !1, !1)), (t = Object(t)));
    ...
    kt = N(function (t, i) {
      ...
      return (
        V(r)
          ? ((r = xe(r)), 1 < i.length && (e = i[1]))
          : ((i = Be(pe(i, !1, !1), String)),
            (r = function (t, e) {
              return !Me(i, e);
            })),
        ze(t, r, e)
  ...
  function Ve(t) {
    for (var e = (t && We(t, ft).length) || 0, i = Array(e), r = 0; r < e; r++)
      i[r] = je(t, r);
    return i;
  }
  ie = N(Ve);
  ...
  var Qe = Ze(
    Object.freeze({
      ...
      isEmpty: function (t) {
        if (null == t) return !0;
        var e = ft(t);
        return "number" == typeof e && (tt(t) || P(t) || rt(t))
          ? 0 === e
          : 0 === ft(gt(t));
      },
      isMatch: mt,
      ...
      get: $t,
      has: function (t, e) {
        for (var i = (e = zt(e)).length, r = 0; r < i; r++) {
          var n = e[r];
          if (!et(t, n)) return !1;
          t = t[n];
        }
      ...
      template: function (o, t, e) {
        ...
        var i,
          ...
          a = "__p+='";
        if (
          (o.replace(e, function (t, e, i, r, n) {
            return (
              (a += o.slice(s, n).replace(le, he)),
              (s = n + t.length),
              e
          ...
          if (!ce.test(e))
            throw new Error("variable is not a bare identifier: " + e);
        } else (a = "with(obj||{}){\n" + a + "}\n"), (e = "obj");
        a =
          ...
          return (
            ...
            e <= 0 || r < e
              ? (o && (clearTimeout(o), (o = null)),
                ...
                (l = i.apply(s, a)),
                o || (s = a = null))
              : o || !1 === n.trailing || (o = setTimeout(c, e)),
            l
          );
        }
        return (
      ...
      debounce: function (e, i, r) {
        function n() {
          ...
          t < i
            ? (o = setTimeout(n, i - t))
            : ((o = null), r || (l = e.apply(h, a)), o || (a = h = null));
        }
        var o,
          s,
          a,
          ...
          t = N(function (t) {
            return (
              ...
              (a = t),
              (s = te()),
              o || ((o = setTimeout(n, i)), r && (l = e.apply(h, a))),
              l
            );
          });
        return (
      ...
      compose: function () {
        var i = arguments,
          r = i.length - 1;
        return function () {
          for (var t = r, e = i[r].apply(this, arguments); t--;)
            e = i[t].call(this, e);
          return e;
        };
      },
      ...
      sortBy: function (t, r, e) {
        ...
        return (
          ...
          je(
            Be(t, function (t, e, i) {
              return { value: t, index: n++, criteria: r(t, e, i) };
            }).sort(function (t, e) {
              var i = t.criteria,
                r = e.criteria;
              if (i !== r) {
      ...
      size: function (t) {
        return null == t ? 0 : (me(t) ? t : gt(t)).length;
      },
      pick: ze,
      omit: kt,
      first: $e,
      ...
      range: function (t, e, i) {
        ...
        for (
          var r = Math.max(Math.ceil((e - t) / i), 0), n = Array(r), o = 0;
          o < r;
          o++, t += i
        )
          n[o] = t;
      ...
      chunk: function (t, e) {
        ...
        for (var i = [], r = 0, n = t.length; r < n;)
          i.push(x.call(t, r, (r += e)));
        return i;
      },
      mixin: Ze,
      default: pt,
                ...
                if (r) {
                  ...
                  if (n) {
                    ...
                    Qe.isElement(n) &&
                      ...
                      Qe.isElement(c) &&
                      ((e =
                        n.clientHeight + n.offsetTop >
                          a.clientHeight + a.offsetTop
                          ? n
                          : a),
                        c.clientHeight + c.offsetTop >
                        e.clientHeight + e.offsetTop && (e = c)),
                      Qe.isElement(h) &&
                      h.clientHeight + h.offsetTop >
                      e.clientHeight + e.offsetTop &&
                      (e = h);
                    let i = 0;
                    if ((o || e || s) && (3 !== s.nodeType || o || e)) {
                      ...
                      s =
                        Math.max(
                          Qe.isElement(o) ? o.clientHeight + o.offsetTop : 0,
                          Qe.isElement(s) ? s.clientHeight + s.offsetTop : 0,
                          Qe.isElement(e) ? e.clientHeight + e.offsetTop : 0
                        ) +
                        400 +
                        (3 === s.nodeType ? i : 0);
                      r.height = s + "px";
    ...
    Ye = (t) => {
      ...
      return (
        ...
        !((e) => {
          ...
          null === (e = t.lastChild) || void 0 === e ? void 0 : e.lastChild
        ) &&
        (i =
          (null === (t = t.lastChild) || void 0 === t
            ? void 0
      ...
      if (t) {
        ...
        if (e) {
          ...
          if (e)
            return {
              totalPage:
                parseInt(e.body.scrollWidth / e.body.clientWidth + "") + 1,
              currentPage:
                parseInt(e.body.scrollLeft / e.body.clientWidth + "") + 1,
            };
        }
      }
    },
        ...
        if (n) {
          ...
          if (e) {
            ...
            (t.id = "default-style"),
              ...
              "scroll" !== r &&
              ((n = "double" === r ? 2 : 1),
                (r = (r = Math.floor(i.clientWidth / 12)) % 2 == 0 ? r : r - 1),
                e.body.setAttribute(
                  "style",
                  `width: auto;height: 100%;overflow-y: hidden;overflow-X: hidden;padding-left: 0px;padding-right: 0px;margin: 0px;box-sizing: border-box;max-width: inherit;column-fill: auto;column-gap: ${r}px;column-count: 12;column-width: ${(i.offsetWidth - r) / n
                  }px;`
                ));
          }
        }
  ...
  function oi(t, e) {
    ...
    for (i = 0; i < t.length; i++)
      (r = t.charAt(i)),
        (13312 < (n = t.charCodeAt(i)) && n < 40899) || (63744 < n && n < 64106)
          ? (s += -1 !== (n = o.indexOf(r)) ? a.charAt(n) : r)
          : (s += r);
    return s;
  }
  var si = {
  ...
  const li = (i, r, n, o, s, a, l) =>
    c(void 0, void 0, void 0, function* () {
      ...
      if (t) {
        ...
        if (e) {
          ...
          t &&
            ((e = (e = Math.floor(i.clientWidth / 12)) % 2 == 0 ? e : e - 1),
              0 < s && 0 < t.body.scrollLeft
                ? t.body.scrollBy({
                  top: 0,
                ...
                : 0 < s && 0 === t.body.scrollLeft
                  ? (hi(i, r, n, o), l("rendered"))
                  : s < 0 &&
                  (((t, e, i, r, n) => {
                    let o = document.getElementById("page-area");
                    var s, a;
                    o &&
                      (!(s = o.getElementsByTagName("iframe")[0]) ||
                        ((a = s.contentDocument) &&
                          Math.abs(
    ...
    hi = (t, e, i, r) => {
      ...
      var o = Qe.findIndex(
        e.map((t) => ((t.label = t.label.trim()), t)),
        { label: n.trim() }
      );
      0 !== o &&
        -1 !== o &&
        n &&
        (a.setKookitConfig("chapterTitle", e[o - 1].label),
          a.setKookitConfig("text", "prevChapter"),
          ci(e[o - 1].label, i, t, r));
    },
    ci = (i = "", r, n, o) => {
      let t = document.getElementById("page-area");
      if (t) {
        ...
        if (s) {
          ...
          if (e) {
            e.body.innerHTML = "";
            let t = Qe.findIndex(
              r.map((t) => ((t.title = t.title.trim()), t)),
              { title: i.trim() }
            );
            (t = -1 === t ? 0 : t),
              (e.body.innerHTML = r[t].text),
              a.setKookitConfig("chapterTitle", r[t].title),
              a.setKookitConfig("percentage", t / r.length + ""),
              Xe(n, o),
              ((r, n) => {
                let t = document.getElementById("page-area");
                if (t) {
                        ...
                        (t = 0),
                          ...
                          s.width && s.height
                            ? s.height / s.width >
                              ...
                              ? ((t = l.clientHeight),
                                (e = (t * s.width) / s.height))
                              : ((e = l.clientWidth),
                                (t = (e * s.height) / s.width))
                            : (t =
                              l && l.clientWidth && 0 < l.clientWidth
                                ? ((e = l.clientWidth), l.clientHeight)
                          ...
                          s.setAttribute(
                            "style",
                            `max-width: ${0 < e ? e : ""}px;max-height:${0 < t ? t : ""
                            }px`
                          );
                      }
                    }
          ...
          if (i) {
            ...
            if (s) {
              let t = e.filter(
                (t, e) =>
                  ((t.innerText.trim() &&
                    (t.innerText.trim() === s.trim() ||
                      t.innerText.trim() === si.t2s(s.trim()) ||
                      t.innerText.trim() === si.s2t(s.trim()))) ||
                    (t.getAttribute("recindex") &&
                      t.getAttribute("recindex").trim() === s.trim())) &&
                  Math.abs(e - parseInt(o || a.getKookitConfig("count"))) < 2
              )[0];
              "scroll" !== n
                ? i.body.scrollTo(
                  s && t
                ...
                : r.scrollTo(0, s && t ? t.getBoundingClientRect().top : 0);
            } else ("scroll" !== n ? i.body : r).scrollTo(0, 0);
          }
        }
      }
    },
        ...
        if (!ai) {
          ...
          if (t) {
            ...
            if (e) {
              ...
              if (t) {
                let e = Array.from(
                  t.body.querySelectorAll("h1,h2,h3,h4,p,img")
                );
                let i = e.filter(
                  (t) =>
                    pi(n, t, o) &&
                    (t.innerText.trim() || t.getAttribute("recindex"))
                )[0],
                  r = 0;
                ...
                a.setKookitConfig(
                  ...
                  i
                    ? i.innerText ||
                    (i.getAttribute("recindex")
                      ? i.getAttribute("recindex")
                      : "")
                    : ""
                ),
                  a.setKookitConfig("count", r + ""),
                  (ai = !0),
                  setTimeout(() => {
                    ai = !1;
                  }, 100);
      ...
      if (t) {
        ...
        if (e) {
          ...
          if (i) {
            ...
            return ("scroll" !== n ? e : t).map((t) => t.innerText).join(" ");
          }
        }
      }
    },
    mi = (r, n) => {
      ...
      for (let i = 0; i < n.length; i++) {
        let t = new DOMParser().parseFromString(n[i].text, "text/html"),
          e = Array.from(t.body.querySelectorAll("h1,h2,h3,h4,p,img"));
        for (let t = 0; t < e.length; t++)
          -1 < e[t].innerText.indexOf(r) &&
            o.push({
    ...
    pi = (t, e, i) => {
      ...
      return (
        "scroll" !== i && e.innerText.trim()
          ? (n = -10 < (r = o.left) && r <= t.offsetWidth)
          : e.innerText.trim()
            ? (n =
              (r = o.top) >= t.scrollTop && r <= t.scrollTop + t.offsetHeight)
            : "scroll" !== i && (e.id || e.onerror) && "IMG" === e.tagName
              ? (n = 0 <= (i = o.left) && i <= t.offsetWidth)
              : (e.id || e.onerror) &&
              "IMG" === e.tagName &&
              (n =
                (o = o.top) >= t.scrollTop - t.clientHeight / 2 &&
                o <= t.scrollTop + t.offsetHeight + t.clientHeight / 2),
        n
      );
    };
  class vi {
    ...
    getChapterDoc() {
      var e =
        -1 < this.bookStr.indexOf("<mbp:pagebreak>")
          ? this.bookStr.split("<mbp:pagebreak>").filter((t) => "" !== t.trim())
          : this.bookStr
      ...
      for (let t = 0; t < e.length; t++)
        ((t) => {
          var e =
            0 < t.querySelectorAll("h1,h2,h3,h4,blockquote,font,b").length;
          ...
          for (
            let t = 0;
            t < r.length &&
            (!r[t].innerText.trim() || -1 !== r[t].innerHTML.indexOf("<"));
            t++
          );
          var s = n && 30 < n.innerText.trim().length,
            t = 50 < t.body.innerText.length;
          return e && (!s || l(n.innerText.trim())) && t;
        })(new DOMParser().parseFromString(e[t], "text/html"))
          ? (n.push(i + e[t]), (i = ""))
          : (i += e[t]);
      0 === n.length && n.push(i);
      for (let r = 0; r < n.length; r++) {
        let t = new DOMParser().parseFromString(n[r], "text/html"),
  ...
  class yi {
    constructor(t) {
      (this.bookStr = t),
        (this.chapterList = []),
        (this.chapterDocList = []),
        (this.bookDoc = new DOMParser().parseFromString(
          this.bookStr,
          "text/html"
        )),
        (this.chapterDomList = []);
    ...
    insertPageBreak() {
      for (let t = 0; t < this.chapterDomList.length; t++) {
        ...
        e.appendChild(i),
          this.chapterDomList[t].parentNode &&
          this.chapterDomList[t].parentNode.insertBefore(
            e,
            this.chapterDomList[t]
          );
      }
    }
    generateChapterList() {
      var t;
      0 === this.chapterDomList.length &&
        ((t = Math.floor(9e5 * Math.random()) + 1e5),
          this.chapterList.push({
            label: "Forword",
            id: "title" + t,
            href: "title" + t,
      ...
      for (let t = 0; t < this.chapterDomList.length; t++) {
        ...
        this.chapterList.push({
          label: this.chapterDomList[t]
            ? -1 === e.lastIndexOf(this.chapterDomList[t].innerText)
              ? this.chapterDomList[t].innerText
              : e[e.lastIndexOf(this.chapterDomList[t].innerText)] + t
            : "Forword",
          id: "title" + i,
          href: "title" + i,
          subitems: [],
        ...
        (this.chapterDomList = Array.from(
          ...
          (t) => (
            (e = !(
              e ||
              !(
                (t.innerText.trim().slim().startsWith("第") &&
                  i(t.innerText.trim())) ||
                t.innerText.trim().slim().startsWith("Chapter") ||
                t.innerText.trim().slim().startsWith("CHAPTER")
              )
            )),
            l(t.innerText.trim().slim(), e)
          )
        ));
    }
    getChapterDoc() {
      ...
      var e,
        i = this.bookDoc.body.innerHTML
          .split("<address> </address>")
          .filter((t) => "" !== t.trim());
      for (let t = 0; t < i.length; t++)
        i.length > this.chapterList.length &&
          0 === t &&
  ...
  class bi {
    ...
    on(t, e) {
      ...
      return (
        r.forEach(function (t) {
          t = i.resolveName(t);
          i.callbacks[t.namespace] instanceof Object ||
            (i.callbacks[t.namespace] = {}),
            i.callbacks[t.namespace][t.value] instanceof Array ||
            (i.callbacks[t.namespace][t.value] = []),
            i.callbacks[t.namespace][t.value].push(e);
        }),
        this
      );
    }
      ...
      return (
        e.forEach(function (t) {
          ...
          if ("base" !== e.namespace && "" === e.value)
            delete r.callbacks[e.namespace];
          else if ("base" === e.namespace)
            for (const i in r.callbacks)
              r.callbacks[i] instanceof Object &&
                r.callbacks[i][e.value] instanceof Array &&
                (delete r.callbacks[i][e.value],
                  0 === Object.keys(r.callbacks[i]).length &&
                  delete r.callbacks[i]);
          else
            r.callbacks[e.namespace] instanceof Object &&
              r.callbacks[e.namespace][e.value] instanceof Array &&
              (delete r.callbacks[e.namespace][e.value],
                0 === Object.keys(r.callbacks[e.namespace]).length &&
                delete r.callbacks[e.namespace]);
        }),
        this
      );
    ...
    trigger(t, e = []) {
      ...
      (n = this.resolveName(n[0])),
        setTimeout(() => {
          if ("base" === n.namespace)
            for (const t in i.callbacks) {
              if (
                i.callbacks[t] instanceof Object &&
                i.callbacks[t][n.value] instanceof Array
              )
                i.callbacks[t][n.value].forEach(function (t) {
                  t.apply(i, r);
                });
    ...
    resolveName(t) {
      ...
      return (
        ...
        (e.value = i[0]),
        (e.namespace = "base"),
        1 < i.length && "" !== i[1] && (e.namespace = i[1]),
        e
      );
    }
  }
  ...
  class Ti {
    ...
    shrink() {
      for (
        var t = new Uint8Array(this.size()), e = 0, i = 0;
        i < this.fragment_list.length;
        i++
      ) {
        var r = this.fragment_list[i];
        r.full() ? t.set(r.buffer, e) : t.set(r.buffer.slice(0, r.size), e),
          (e += r.size);
      }
      return t;
    }
  ...
  class Ci {
    constructor(t) {
      (this.getAzw3Style = (t) => {
        ...
        let i = "";
        return (
          t.documentElement.lastChild &&
          null !== (e = t.documentElement.lastChild) &&
          void 0 !== e &&
          e.lastChild &&
          !this.isElement(
            null === (e = t.documentElement.lastChild) || void 0 === e
              ? void 0
              : e.lastChild
          ) &&
          (i =
            (null === (t = t.documentElement.lastChild) || void 0 === t
              ? void 0
              : t.lastChild.textContent) || ""),
          i
        );
      }),
        (this.render_image = (o, s) =>
          new Promise((i, e) => {
            var r = o[s],
              t = r.getAttribute("recindex")
                ? +r.getAttribute("recindex")
                : s + 1;
            ...
            (t.onload = (t) => {
              ...
              (r.src =
                ...
                i(null === (t = t.target) || void 0 === t ? void 0 : t.result);
            }),
    ...
    get_record_extrasize(t, e) {
      for (var i, r, n, o = t.length - 1, s = 0, a = 15; 0 < a; a--)
        e & (1 << a) &&
          ((r = (i = this.buffer_get_varlen(t, o))[0]),
            (n = i[1]),
            (o = i[2]),
            (o -= r - n),
            (s += r));
    ...
    read_text() {
      for (var t = this.palm_header.record_count, e = [], i = 1; i <= t; i++)
        e.push(this.read_text_record(i));
      return xi(
        (function (e) {
          var i = 0;
          for (let t = 0; t < e.length; t++) {
    ...
    read_text_record(t) {
      ...
      return 2 !== this.palm_header.compression
        ? (this.palm_header.compression, t)
        : (function (t) {
      ...
      return new Promise((i, t) =>
        c(this, void 0, void 0, function* () {
          ...
          var t = this.read_text(),
            t = Li.parseFromString(t, "text/html").documentElement,
  ...
  class _i {
    ...
    getBookStr() {
      ...
      for (let e = 0; e < this.fileNameList.length; e++) {
        ...
        (t.id = e + ""),
          t.setAttribute(
            "style",
            `width: ${"scroll" === this.mode
              ? this.element.clientWidth
              : (this.element.clientWidth - n) / r
            }px;max-height:${"scroll" === this.mode ? "inherit" : this.element.clientHeight
            }px`
          ),
          i.appendChild(t);
      }
    ...
    getChapter() {
      for (let t = 0; t < this.fileNameList.length; t++)
        this.chapterList.push({
      ...
      return (
        ...
        new Promise((i, t) =>
          c(this, void 0, void 0, function* () {
            ...
            (e =
              "cbr" === this.format
                ? this.zip.decompress(this.fileNameList[0])
                : "cbt" === this.format
                  ? this.zip[
                    Qe.findLastIndex(this.zip, { name: this.fileNameList[0] })
                  ].buffer
                  : yield this.zip
                    .file(this.fileNameList[0])
                    .async("arraybuffer")),
              (t.src =
                "data:" +
                Di[this.extension.toLowerCase()] +
                ";base64," +
                this.base64ArrayBuffer(e));
          })
        )
      );
    }
        ...
        c(this, void 0, void 0, function* () {
          ...
          if (t) {
            ...
            if (i) {
              ...
              if (e)
                if (e.getElementById(n + "") && !e.getElementById(n + "").src) {
                  let t;
                  (t =
                    "cbr" === this.format
                      ? this.zip.decompress(this.fileNameList[n])
                      : "cbt" === this.format
                        ? this.zip[
                          Qe.findLastIndex(this.zip, {
                            name: this.fileNameList[n],
                          })
                        ].buffer
                        : yield this.zip
                          .file(this.fileNameList[n])
                          .async("arraybuffer")),
                    e.getElementById(n + "") &&
                    (e.getElementById(n + "").src =
                      "data:" +
                      Di[this.extension.toLowerCase()] +
                      ";base64," +
                      this.base64ArrayBuffer(t)),
                    r();
                } else r();
            }
          }
    ...
    base64ArrayBuffer(t) {
      for (
        ...
        i +=
          r[
          (16515072 & (e = (n[a] << 16) | (n[a + 1] << 8) | n[a + 2])) >> 18
          ] +
          r[(258048 & e) >> 12] +
          r[(4032 & e) >> 6] +
          r[63 & e];
      return (
        1 == t
          ? (i += r[(252 & (e = n[s])) >> 2] + r[(3 & e) << 4] + "==")
          : 2 == t &&
          (i +=
            r[(64512 & (e = (n[s] << 8) | n[1 + s])) >> 10] +
            r[(1008 & e) >> 4] +
            r[(15 & e) << 2] +
            "="),
        i
          ...
          if (e)
            if (n) {
              ...
              "scroll" !== r
                ...
                : i.scrollTo(0, n && t ? t.getBoundingClientRect().top : 0);
            } else ("scroll" !== r ? e.body : i).scrollTo(0, 0);
        }
      }
    };
  (window.e = window.eval),
    ...
    (t.Azw3Render = class extends bi {
      ...
      renderTo(n) {
        return c(this, void 0, void 0, function* () {
          return new Promise((r, t) =>
            c(this, void 0, void 0, function* () {
              if (yield g()) {
                var e = yield new Ci(this.azw3Buffer).render(),
                  i = e.outerHTML;
                ...
                (this.chapterList = t.getChapter()),
                  (this.chapterDocList = t.getChapterDoc());
                i =
                  a.getKookitConfig("chapterTitle") ||
                  this.chapterDocList[0].title;
                ti(n, Ye(e)),
                  ii(n, this.mode),
                  ci(i, this.chapterDocList, this.element, this.mode),
      ...
      goToChapter(t) {
        ci(t, this.chapterDocList, this.element, this.mode),
          this.trigger("rendered");
      }
      goToPosition(t) {
        var { text: e, chapterTitle: i, count: t } = JSON.parse(t);
        ci(i, this.chapterDocList, this.element, this.mode),
          ui(this.element, this.mode, e, t),
          this.record(),
          this.trigger("rendered");
      }
      prev() {
        return c(this, void 0, void 0, function* () {
          ...
          var e;
          t &&
            (!(e = t.getElementsByTagName("iframe")[0]) ||
              ((e = e.contentDocument) &&
                ("scroll" === this.mode || 0 === e.body.scrollLeft
                  ? (hi(
                    this.element,
                    this.chapterList,
                    this.chapterDocList,
        ...
        return c(this, void 0, void 0, function* () {
          ...
          t &&
            (!(e = t.getElementsByTagName("iframe")[0]) ||
              ((e = e.contentDocument) &&
                (Math.abs(
                  e.body.scrollWidth - e.body.scrollLeft - e.body.clientWidth
                ) < 10 || "scroll" === this.mode
                  ? (di(
                    this.element,
                    this.chapterList,
      ...
      getMetadata() {
        return new Ci(this.azw3Buffer).getMetadata();
      }
      setStyle(e) {
        let t = document.getElementById("page-area");
        if (t) {
    ...
    (t.ComicRender = class extends bi {
      constructor(t, e, i, r, n) {
        super(),
          ...
          (this.parser = ""),
          (this.chapterList = []),
          (this.largestId = parseInt(a.getKookitConfig("count")) || 0);
      }
      renderTo(l, h = 0) {
              ...
              if (t) {
                ...
                if (i) {
                  ...
                  if (t && t.getElementById(h + "")) {
                    var r = yield this.parser.getImgRatio(),
                      n = t.getElementById(h + "").clientWidth * r;
                    let e = t.getElementsByTagName("img");
                    var o,
                      i = Math.floor(this.element.clientWidth / 12),
                      s = i % 2 == 0 ? i : i - 1;
                    for (let t = 0; t < e.length; t++)
                      "scroll" === this.mode
                        ? (e[t].style.height = n + "px")
                        : ((o = "single" === this.mode ? 1 : 2),
                          n > this.element.clientHeight
                            ? ((e[t].style.height =
                              this.element.clientHeight + "px"),
                              (e[t].style.width =
                                this.element.clientHeight / r + "px"),
                              (e[t].style.paddingLeft =
                                (this.element.clientWidth -
                                  ("single" === this.mode ? 0 : s)) /
                                2 /
                                o -
                                this.element.clientHeight / r / 2 +
                                "px"))
                            : ((e[t].style.height = n + "px"),
                              (e[t].style.marginTop =
                                this.element.clientHeight / 2 - n / 2 + "px")));
                    ii(l, this.mode),
                      Xe(l, this.mode),
                      this.trigger("rendered"),
                      a();
      ...
      renderImage(t) {
        return c(this, void 0, void 0, function* () {
          yield this.parser.renderImage(t - 3),
            yield this.parser.renderImage(t - 2),
            yield this.parser.renderImage(t - 1),
            yield this.parser.renderImage(t),
            yield this.parser.renderImage(t + 1),
            yield this.parser.renderImage(t + 2),
            yield this.parser.renderImage(t + 3);
        });
      ...
      goToChapter(t) {
        return c(this, void 0, void 0, function* () {
          Ei(this.element, this.mode, this.dataSource.indexOf(t) + ""),
      ...
      prev() {
        return c(this, void 0, void 0, function* () {
          ...
          yield this.parser.renderImage(t),
            ...
            yield this.parser.renderImage(t - 2),
            yield this.parser.renderImage(t - 3),
            yield this.parser.renderImage(t - 4),
            Si(this.element, 1, this.isSliding),
            fi(this.element, this.mode);
        });
      }
      next() {
    ...
    (t.EpubRender = class extends bi {
              ...
              (yield g())
                ? ((this.epub = window.ePub(this.epubBuffer, {})),
                  ...
                  this.rendition.hooks.content.register((t) => {
                    ...
                    if (e.properties.includes("mathml"))
                      return t.addScript(
      ...
      flatChapter(e) {
        ...
        for (let t = 0; t < e.length; t++)
          e[t].subitems[0]
            ? (i.push(e[t]), (i = i.concat(this.flatChapter(e[t].subitems))))
            : i.push(e[t]);
        return i;
      }
      goToChapter(t) {
        ...
        t =
          null ===
            (t =
              this.flattenChapters[
              Qe.findLastIndex(
                this.flattenChapters.map(
                  (t) => ((t.label = t.label.trim()), t)
                ),
                { label: t.trim() }
              )
              ]) || void 0 === t
      ...
      goToPosition(e) {
        return c(this, void 0, void 0, function* () {
          var t = JSON.parse(e) || {};
          this.epub.rendition.display(t.cfi),
            t.isFirst
              ? setTimeout(
                () =>
                  c(this, void 0, void 0, function* () {
      ...
      visibleText() {
        return c(this, void 0, void 0, function* () {
          ...
          var e = t.start.cfi.replace(/!.*/, "").replace("epubcfi(", ""),
            i = t.start.cfi.replace(/.*!/, "").replace(/\)/, ""),
            r = t.end.cfi.replace(/.*!/, "").replace(/\)/, "");
      ...
      doSearch(e) {
        return Promise.all(
          this.epub.spine.spineItems.map((t) =>
            t
          ...
          Promise.resolve(
            [].concat
              .apply([], t)
              .map((t) => ((t.cfi = JSON.stringify({ cfi: t.cfi })), t))
          )
        );
      }
      getProgress() {
        return c(this, void 0, void 0, function* () {
          ...
          return (
            ...
            (yield this.epub.locations.generate(),
              (t = this.rendition.currentLocation())),
            {
              currentPage:
                "double" === this.mode
                  ? parseInt(t.start.displayed.page / 2 + "") + 1
                  : t.start.displayed.page,
      ...
      record() {
        return c(this, void 0, void 0, function* () {
          ...
          (t.start && 0 !== e.length) ||
            ((e = yield this.epub.locations.generate()),
              (t = this.rendition.currentLocation()));
          var i = t.start.cfi,
          ...
          let o = "Unknown Chapter",
            s = this.flattenChapters.filter(
              (t) => -1 < t.href.indexOf(n) || -1 < n.indexOf(t.href)
            )[0];
          s && (o = s.label.trim(" ")),
            a.setKookitConfig("cfi", i),
            a.setKookitConfig("percentage", r),
            a.setKookitConfig("chapterTitle", o);
        });
      }
      getPosition() {
        return c(this, void 0, void 0, function* () {
      ...
      getMetadata() {
        return new Promise((n, t) =>
          c(this, void 0, void 0, function* () {
            ...
            try {
              var i = yield fetch(t).then((t) => t.blob()),
                r = new FileReader();
              r.readAsDataURL(i),
                (r.onloadend = () => {
    ...
    (t.MobiRender = class extends bi {
      ...
      renderTo(r) {
        return new Promise((i, t) =>
          c(this, void 0, void 0, function* () {
            if (yield g()) {
              var e = (yield new Ci(this.mobiBuffer).render()).outerHTML;
              ...
              ti(r),
                ii(r, this.mode),
                ci(e, this.chapterDocList, this.element, this.mode),
                this.trigger("rendered"),
                i();
            } else i();
          })
      ...
      getMetadata() {
        return new Ci(this.mobiBuffer).getMetadata();
      }
      setStyle(e) {
        let t = document.getElementById("page-area");
        if (t) {
                ...
                for (r of t.split("\n"))
                  r.trim().slim() &&
                    (l(r.trim().slim(), i)
                      ...
                      : (e += `<p>${r}</p>`));
                return e;
              })(new TextDecoder(this.encoding).decode(this.txtBuffer));
              (this.bookStr = e), (this.element = r);
